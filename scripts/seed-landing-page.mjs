...
const landingDefaults = {
  ...
  finalCtaSection: {
    badge: 'Next Step',
    titleLine1: 'Your next level won\u2019t come',
    titleLine2: 'from working harder.',
    description: 'Book a free 30-minute strategy call. We\u2019ll find your real constraint and map your next 90 days \u2014 and you leave with a plan, whether or not we ever work together.',
    primaryCta: {
      label: 'Book a Free Strategy Call',
      href: '/contact',
    },
